 ...
 * 
 * @file
 *   Main file that imports the other stuff.
...
const MOD_API = bcModSdk.registerMod(
{
  name: "ACBC",
  version: ACBC_VERSION,
  fullName: "Alice Churchfield Bondage Club",
...
// Bookmarklet code:
//   javascript:(()=>{fetch('https://alicechurchfield.github.io/acbc/acbc.js').then(r=>r.text()).then(r=>eval(r));})();

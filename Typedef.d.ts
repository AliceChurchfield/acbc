...
/**
 * A ChatRoomMessageHandler used by ACBC. Includes a flag indicating that it's
 * an ACBC handler, so that it can be found easily in BC's main array of
 * ChatRoomMessage event handlers.
 */
interface AcbcChatRoomMessageHandler extends ChatRoomMessageHandler
{
  ACBC?: boolean;
}
 ...
 *
 * @param {AcbcChatRoomMessageHandler} handler - The handler to register
 */
declare function ChatRoomRegisterMessageHandler(
  handler: AcbcChatRoomMessageHandler): void;
